...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~lidzyDjD#fBHLGQDkQaWb82IS2lMKo4n26W-whw6WOvqphG3-i8w",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "emjay-xe",
...
OWNER_NAME: process.env.OWNER_NAME || "emjay",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*© emjay great 😃*",
// add bot owner name    
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "233538722180",
